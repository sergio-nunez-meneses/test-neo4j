...
CREATE
    (o1)-[:PUBLISHED_BY]->(u7),
    (tc3)<-[:REFERS_TO]-(o1)-[:REFERS_TO]->(c7),
    (o1)-[:IS_TYPE_TAKEOVER]->(to1),
    (to1)-[:IS_LOCATED]->(lo16),
    (o2)-[:PUBLISHED_BY]->(u3),
    (tc5)<-[:REFERS_TO]-(o2)-[:REFERS_TO]->(c6),
    (o2)-[:IS_TYPE_JOB]->(jo2),
    (jo2)-[:BELONGS_TO]->(co3),
    (co3)-[:IS_LOCATED]->(lo1),
    (o3)-[:PUBLISHED_BY]->(u8),
    (tc3)<-[:REFERS_TO]-(o3)-[:REFERS_TO]->(c9),
    (o3)-[:IS_TYPE_ESTATE]->(eo3),
    (eo3)-[:IS_LOCATED]->(lo7),
    (o4)-[:PUBLISHED_BY]->(u9),
    (tc8)<-[:REFERS_TO]-(o4)-[:REFERS_TO]->(c10),
    (o4)-[:IS_TYPE_TAKEOVER]->(to4),
    (to4)-[:IS_LOCATED]->(lo3),
    (o5)-[:PUBLISHED_BY]->(u1),
    (tc2)<-[:REFERS_TO]-(o5)-[:REFERS_TO]->(c4),
    (o5)-[:IS_TYPE_JOB]->(jo5),
    (jo5)-[:BELONGS_TO]->(co4),
    (co4)-[:IS_LOCATED]->(lo12),
    (o6)-[:PUBLISHED_BY]->(u4),
    (tc7)<-[:REFERS_TO]-(o6)-[:REFERS_TO]->(c7),
    (o6)-[:IS_TYPE_ESTATE]->(eo6),
    (eo6)-[:IS_LOCATED]->(lo13),
    (o7)-[:PUBLISHED_BY]->(u8),
    (tc10)<-[:REFERS_TO]-(o7)-[:REFERS_TO]->(c3),
    (o7)-[:IS_TYPE_TAKEOVER]->(to7),
    (to7)-[:IS_LOCATED]->(lo2),
    (o8)-[:PUBLISHED_BY]->(u10),
    (tc5)<-[:REFERS_TO]-(o8)-[:REFERS_TO]->(c6),
    (o8)-[:IS_TYPE_JOB]->(jo8),
    (jo8)-[:BELONGS_TO]->(co4),
    (co4)-[:IS_LOCATED]->(lo21),
    (o9)-[:PUBLISHED_BY]->(u3),
    (tc5)<-[:REFERS_TO]-(o9)-[:REFERS_TO]->(c9),
    (o9)-[:IS_TYPE_ESTATE]->(eo9),
    (eo9)-[:IS_LOCATED]->(lo12),
    (o10)-[:PUBLISHED_BY]->(u8),
    (tc4)<-[:REFERS_TO]-(o10)-[:REFERS_TO]->(c4),
    (o10)-[:IS_TYPE_TAKEOVER]->(to10),
    (to10)-[:IS_LOCATED]->(lo13),
    (o11)-[:PUBLISHED_BY]->(u8),
    (tc8)<-[:REFERS_TO]-(o11)-[:REFERS_TO]->(c5),
    (o11)-[:IS_TYPE_JOB]->(jo1),
    (jo1)-[:BELONGS_TO]->(co6),
    (co6)-[:IS_LOCATED]->(lo26),
    (o12)-[:PUBLISHED_BY]->(u8),
    (tc7)<-[:REFERS_TO]-(o12)-[:REFERS_TO]->(c2),
    (o12)-[:IS_TYPE_ESTATE]->(eo2),
    (eo2)-[:IS_LOCATED]->(lo20),
    (o13)-[:PUBLISHED_BY]->(u6),
    (tc5)<-[:REFERS_TO]-(o13)-[:REFERS_TO]->(c3),
    (o13)-[:IS_TYPE_TAKEOVER]->(to3),
    (to3)-[:IS_LOCATED]->(lo2),
    (o14)-[:PUBLISHED_BY]->(u10),
    (tc1)<-[:REFERS_TO]-(o14)-[:REFERS_TO]->(c9),
    (o14)-[:IS_TYPE_JOB]->(jo4),
    (jo4)-[:BELONGS_TO]->(co10),
    (co10)-[:IS_LOCATED]->(lo9),
    (o15)-[:PUBLISHED_BY]->(u1),
    (tc6)<-[:REFERS_TO]-(o15)-[:REFERS_TO]->(c9),
    (o15)-[:IS_TYPE_ESTATE]->(eo5),
    (eo5)-[:IS_LOCATED]->(lo17),
    (o16)-[:PUBLISHED_BY]->(u10),
    (tc6)<-[:REFERS_TO]-(o16)-[:REFERS_TO]->(c1),
    (o16)-[:IS_TYPE_TAKEOVER]->(to6),
    (to6)-[:IS_LOCATED]->(lo23),
    (o17)-[:PUBLISHED_BY]->(u9),
    (tc5)<-[:REFERS_TO]-(o17)-[:REFERS_TO]->(c9),
    (o17)-[:IS_TYPE_JOB]->(jo7),
    (jo7)-[:BELONGS_TO]->(co8),
    (co8)-[:IS_LOCATED]->(lo7),
    (o18)-[:PUBLISHED_BY]->(u4),
    (tc4)<-[:REFERS_TO]-(o18)-[:REFERS_TO]->(c8),
    (o18)-[:IS_TYPE_ESTATE]->(eo8),
    (eo8)-[:IS_LOCATED]->(lo4),
    (o19)-[:PUBLISHED_BY]->(u10),
    (tc2)<-[:REFERS_TO]-(o19)-[:REFERS_TO]->(c6),
    (o19)-[:IS_TYPE_TAKEOVER]->(to9),
    (to9)-[:IS_LOCATED]->(lo2),
    (o20)-[:PUBLISHED_BY]->(u7),
    (tc6)<-[:REFERS_TO]-(o20)-[:REFERS_TO]->(c7),
    (o20)-[:IS_TYPE_JOB]->(jo10),
    (jo10)-[:BELONGS_TO]->(co4),
    (co4)-[:IS_LOCATED]->(lo7),
    (o21)-[:PUBLISHED_BY]->(u1),
    (tc6)<-[:REFERS_TO]-(o21)-[:REFERS_TO]->(c7),
    (o21)-[:IS_TYPE_ESTATE]->(eo1),
    (eo1)-[:IS_LOCATED]->(lo29),
    (o22)-[:PUBLISHED_BY]->(u4),
    (tc1)<-[:REFERS_TO]-(o22)-[:REFERS_TO]->(c1),
    (o22)-[:IS_TYPE_TAKEOVER]->(to2),
    (to2)-[:IS_LOCATED]->(lo17),
    (o23)-[:PUBLISHED_BY]->(u4),
    (tc2)<-[:REFERS_TO]-(o23)-[:REFERS_TO]->(c8),
    (o23)-[:IS_TYPE_JOB]->(jo3),
    (jo3)-[:BELONGS_TO]->(co2),
    (co2)-[:IS_LOCATED]->(lo15),
    (o24)-[:PUBLISHED_BY]->(u10),
    (tc2)<-[:REFERS_TO]-(o24)-[:REFERS_TO]->(c6),
    (o24)-[:IS_TYPE_ESTATE]->(eo4),
    (eo4)-[:IS_LOCATED]->(lo6),
    (o25)-[:PUBLISHED_BY]->(u8),
    (tc5)<-[:REFERS_TO]-(o25)-[:REFERS_TO]->(c8),
    (o25)-[:IS_TYPE_TAKEOVER]->(to5),
    (to5)-[:IS_LOCATED]->(lo5),
    (o26)-[:PUBLISHED_BY]->(u2),
    (tc3)<-[:REFERS_TO]-(o26)-[:REFERS_TO]->(c7),
    (o26)-[:IS_TYPE_JOB]->(jo6),
    (jo6)-[:BELONGS_TO]->(co1),
    (co1)-[:IS_LOCATED]->(lo15),
    (o27)-[:PUBLISHED_BY]->(u2),
    (tc1)<-[:REFERS_TO]-(o27)-[:REFERS_TO]->(c3),
    (o27)-[:IS_TYPE_ESTATE]->(eo7),
    (eo7)-[:IS_LOCATED]->(lo8),
    (o28)-[:PUBLISHED_BY]->(u6),
    (tc4)<-[:REFERS_TO]-(o28)-[:REFERS_TO]->(c3),
    (o28)-[:IS_TYPE_TAKEOVER]->(to8),
    (to8)-[:IS_LOCATED]->(lo25),
    (o29)-[:PUBLISHED_BY]->(u4),
    (tc2)<-[:REFERS_TO]-(o29)-[:REFERS_TO]->(c6),
    (o29)-[:IS_TYPE_JOB]->(jo9),
    (jo9)-[:BELONGS_TO]->(co4),
    (co4)-[:IS_LOCATED]->(lo19),
    (o30)-[:PUBLISHED_BY]->(u8),
    (tc4)<-[:REFERS_TO]-(o30)-[:REFERS_TO]->(c2),
    (o30)-[:IS_TYPE_ESTATE]->(eo10),
    (eo10)-[:IS_LOCATED]->(lo26);